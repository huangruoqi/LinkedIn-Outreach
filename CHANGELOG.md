...
### Added
- GitHub Actions CI pipeline: runs tests on every push and PR to `main` (Python 3.10 + 3.12 matrix)
...
- Repo URL marker comments in `README.md` and `CONTRIBUTING.md` for easy find-and-replace when the repo moves
